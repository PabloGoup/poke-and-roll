...
export const TRANSICIONES_VALIDAS: Record<ModuloAgente, ModuloAgente[]> = {
  ...
  ATENCION:            ['DESPEDIDA'],
  PEDIDOS:             ['CONSULTAS', 'PEDIDOS', 'ORDEN_COMPRA', 'TIPO_ENTREGA', 'ORDEN_CANCELACION', 'ATENCION'],
  ORDEN_COMPRA:        ['CONSULTAS', 'PEDIDOS', 'CONFIRMACION', 'ORDEN_CANCELACION'],
  ORDEN_CANCELACION:   ['DESPEDIDA', 'BIENVENIDA'],
  CONFIRMACION:        ['CONSULTAS', 'PEDIDOS', 'TIPO_ENTREGA', 'ORDEN_CANCELACION'],
